...
Sphere::Sphere(Vector origin_coord, float radius, Material *material)
...
Intersection Sphere::intersect(Ray ray)
{
  ...
  if (D >= 0)
  {
    ...
    if (t > 0)
    {
      ...
      Vector hitpoint = ray.origin_coord_ + ray.direction_unit_vec_ * t;
      Vector normal = (hitpoint - origin_coord_) / radius_;
